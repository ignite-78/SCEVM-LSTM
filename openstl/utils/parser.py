...
########################################################################################################################
    ...
    #parser.add_argument('--ex_name', '-ex', default='cikm_simvp-1e-3-20epoch-batch-4-s3t4-32-128', type=str)
    parser.add_argument('--ex_name', '-ex', default='cikm_scevm_lstm', type=str)
    #parser.add_argument('--ex_name', '-ex', default='hko7_simvp-b4-epoch50', type=str)
########################################################################################################################
    ...
    parser.add_argument('--broadcast_buffers', action='store_false', default=False,
    ...
    parser.add_argument('--data_root', default='./data/cikm_128')########################################

    parser.add_argument('--dataname', '-d', default='cikm', type=str,  ######################
    ...
    # method parameters
    parser.add_argument('--method', '-m', default='scevm_lstm', type=str,
                        choices=['scevm_lstm'],
                        help='Name of video prediction method to train (default: "scevm_lstm")')

    parser.add_argument('--config_file', '-c', default='configs/cikm/scevm_lstm.py', type=str,
